...
class TestOverlay(unittest.TestCase):
    def setUp(self):
        self.background: AudioSegment = open_audio('test-asset/raw-data/backgrounds/1.mp3')
        self.activate: AudioSegment = open_audio('test-asset/raw-data/activates/1_2.wav')
    ...
    def test_insert_audio_clip(self, rand):
        ...
        self.assertEqual((2254, 3321), segment_time)
